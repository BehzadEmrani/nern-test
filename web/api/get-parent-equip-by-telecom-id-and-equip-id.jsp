...
<%
    ...
    List<Equipment> equipmentList = EquipmentDAO.findParentEquipmentsByTelecomIdAndEquipId( Long.valueOf(request.getParameter("telecom-id")),Long.valueOf(request.getParameter("equip-id")));
    ...
    for (Equipment equipment :equipmentList ) {
        ...
        installResponse.setEquipmentName(equipment.getEquipmentShoaNo());
        ...
        installResponse.setEquipmentTypeName(equipmentType.getName());
