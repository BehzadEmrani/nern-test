...
function getTableData(delta) {
    ...
    var url = "show-uni-fragment.jsp?sub-code=" + subCode + "&page=" + pageNo + "&national-id=" + fNationalId + "&uni-name="
...
function getUniData(nationalId) {
    ...
    var xmlHttp = new XMLHttpRequest();
    var url = "show-uni-info-fragment.jsp?sub-code=" + subCode + "&id=" + nationalId;
    xmlHttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200)
