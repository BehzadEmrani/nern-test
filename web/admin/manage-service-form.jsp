...
<%
    ...
    String ServiceFormParameterJson = "";
    if (isEdit) {
        ...
        ServiceFormParameterJson = gson.toJson(serviceFormParameterList).replaceAll("\"", "'");
    }
...
<body>
<% if (addSubAccess) { %>
<form id="send-service-form" method="post" action="manage-service-form.jsp"
    ...
    <div class="formBox">
        ...
        <table class="formTable" id="sla-table" style="width: 100%" tr-no="0" json="<%=ServiceFormParameterJson%>">
            <caption>
                تعریف خدمت
            </caption>
            <tr>
        ...
        <div class="formRow" style=" display: table; width: 100%;">
            ...
            <%if (isEdit) {%>
            <a class="btn btn-primary formBtn" href="manage-service-form.jsp"
...
<% if (readSubAccess) { %>
<div class="formBox">
    <form id="send-service-form" action="manage-service-form.jsp">
        <div class="formBox">
            <div class="formItem">
                <label>دسته :</label>
    ...
    <table class="fixed-table table table-striped">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="manage-service-form.jsp?action=edit&id=<%=serviceFormTable.getId()%>"
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="manage-service-form.jsp?action=delete&id=<%=serviceFormTable.getId()%>"
                ...
                <div class="modal fade" id="activeModal<%=serviceFormTable.getId()%>" role="dialog">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">خیر</button>
                                <a href="manage-service-form.jsp?action=active-toggle&id=<%=serviceFormTable.getId()%>"
                                   style="float: left;" class="btn btn-default">بله</a>
                            </div>
                        </div>
                    </div>
...
<script src="js/manage-service-form.js"></script>
</body>
</html>