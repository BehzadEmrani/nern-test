            ...
            if (a)for (c = 0; c < a.length; c++) {
                ...
                if (e) g.value ? f.text(g.value) : f.text(""); else {
                    ...
                    if (void 0 !== g.type) {
                        ...
                        k ? (h = this.valueText, g.legendValueText && (h = g.legendValueText), h = b.formatString(h, k)) : l && b.formatPeriodString && (l = d.massReplace(l, {"[[title]]": g.title}), h = b.formatPeriodString(l, g))
    ...
    d.AmMap = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            if (!this.descriptionsDiv) {
                ...
                b.left = "0px";
                b.top = "0px";
                a.classList.add("ammapDescriptionWindowParent");
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    var m = b.realHeight, n = b.realWidth, p = b.mapWidth, t = b.mapHeight;
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var f = c.buttonSize, g = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor,
                ...
                t = c.buttonCornerRadius, r = c.buttonRollOverColor, q = c.gridHeight, y = c.zoomFactor,
...
(function () {
    ...
    d.AreasSettings = d.Class({
        construct: function (a) {
            ...
            this.selectedColor = this.rollOverOutlineColor = "#6a8fb3";
