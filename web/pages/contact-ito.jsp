...
<div class="formBox" style="border: none;">
 ...
 آدرس :
        ...
        <p style="text-align: left;direction: ltr;">http://ito.gov.ir/ </p> <br>
    ...
    تلفن مرکزی :
        ...
        <br>
        <span style="color:#c00">
تلفن اداره کل مدیریت یکپارچه شبکه ملی اطلاعات :
        </span>
    ...
    <div class="mapBox aboutBox col-xs-12 col-sm-6" style=" height:400px;">
        <div class="mapShow" lat="35.739604" lng="51.446799" marker-title="سازمان فناوري اطلاعات ايران"></div>
    </div>
</div>
