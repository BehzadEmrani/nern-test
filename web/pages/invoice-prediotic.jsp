...
<div class="pageLayout">
                    ...
                    <table class="featuresTable">
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold">
                                <%=String.format("%,.0f", serviceFormParameter.getPeriodicPayment() * 1.09)%>ریال
                            </td>
                        </tr>
                        <tr>
    ...
    <table id="serviceTable">
        ...
        <tr>
            ...
            <td><%=String.format("%,d", serviceFormParameter.getPeriodicPayment())%>
            </td>
            <td><%=String.format("%,.0f", serviceFormParameter.getPeriodicPayment() * 0.09)%>
            </td>
            <td><%=String.format("%,.0f", serviceFormParameter.getPeriodicPayment() * 1.09)%>
            </td>
        </tr>
        <tr>
            <td colspan="8">
